...
public class ServicoConfig {
    ...
    public static void salvarConfig(String identificador, String host, int porta,
            int fps, double qualidade, int limiteKbps, double escala)
            throws SQLException {
        String sql = """
    ...
    public static String[] carregarConfig(String identificador) throws SQLException {
        String sql = "SELECT host, porta, fps, qualidade, limite_kbps, escala FROM configuracoes WHERE identificador = ?";
